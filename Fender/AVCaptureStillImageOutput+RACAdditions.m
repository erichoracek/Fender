//
//  AVCaptureStillImageOutput+RACAdditions.m
//  Fender
//
...
@implementation AVCaptureStillImageOutput (RACAdditions)

- (RACSignal *)aut_captureImage {

    return [RACSignal createSignal:^RACDisposable *(id<RACSubscriber> subscriber) {
        AVCaptureConnection *connection = self.connections.lastObject;
